import { mercadoLivreCallback, mercadolibreResToken, mercadolibreResCache, } from "../controllers/mercadoLivreController";
import axios from "axios";
export async function mercadoLivreRoutes(app) {
    ...
    app.get("/api/auth/mercadolivre/login", async function (request, reply) {
        const redirect_uri = process.env.ML_REDIRECT_URI;
        const client_id = process.env.ML_CLIENT_ID;
    ...
    app.get("/auth/cache", async (request, reply) => {
