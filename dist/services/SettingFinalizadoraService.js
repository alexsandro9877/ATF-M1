        ...
        try {
            data.forEach(async (newObj) => {
                if (newObj.cod_int_sap_sim === null) {
                    throw new Error("cod_int_sap_sim é obrigatório para criar/atualizar uma finalizadora.");
                }
            ...
            throw new Error(`Erro ao criar/atualizar a finalizadora: ${error.message}`);
        }
    }
}
